...
from breadboard.components import (
    ...
    potentiometer, relay, seven_segment,
)

# kept referenced so the registration side effect is explicit; importing each
# module runs its @register(...) decorator.
_KIND_MODULES = (resistor, led, capacitor, diode, transistor, button, block, crystal, inductor, buzzer, potentiometer, relay, seven_segment)
